...
export const metadata: Metadata = {
  title: "About HEAL Community",
  description:
    "Learn about HEAL Community — Healthcare Education & Awareness Lab, its mission, principles, origins, and approach to making healthcare knowledge clearer, more accessible, and more useful.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
